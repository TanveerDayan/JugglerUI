...
<div class="ui cards">
<h3 class="ui dividing header">Friend Suggestion</h3>
	<c:forEach var="friend" items="${friendSuggestion}">
		<div class="card" style="width: 110px; height: 195px"
			...
			<div class="extra content">
				<a class="friends"
					onclick="friendAction('<c:out value="${friend.id}"/>','addFriend')">
					<i class="user icon"></i>Add</a>
			</div>
		</div>
	</c:forEach>
</div>